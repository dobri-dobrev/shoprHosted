  ...
  var SwipeableCardView = ionic.views.View.inherit({
    ...
    bindEvents: function() {
      ...
      ionic.onGesture('swiperight', function(e) {
        window.rAF(function() { self._swipeRight(e) });
      }, this.el);

      ionic.onGesture('dragright', function(e) {
        window.rAF(function() { self._dragRight(e) });
      }, this.el);

      ionic.onGesture('swipeleft', function(e) {
        window.rAF(function () { self._swipeLeft(e) });
      }, this.el);

      ionic.onGesture('dragleft', function(e) {
        window.rAF(function() { self._dragLeft(e) });
      }, this.el);
    ...
    _doDragStart: function(e) {
      ...
      console.log('Touch distances', this.touchDistance);//this.touchDistance, width);
    },
    ...
    _doDragEnd: function(e) {
      ...
      console.log(e.gesture);
      if (e.gesture.deltaX > 125) {
        this.removeRight(e);
      } else if (e.gesture.deltaX < -125) {
        this.removeLeft(e);
      }
      else {
        this.backToPos(e);
